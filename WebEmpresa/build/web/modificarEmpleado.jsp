<%-- 
    ...
    Created on : 20-05-2019, 12:38:05
    Author     : duoc
--%>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="modificarEmpleado.jsp">Modificar</a></li>
                ...
                <div class="col-sm-8">
                    <c:if test="${respuesta!=null}">
                        <c:if test="${respuesta==true}">
                            <div class="alert alert-success">Empleado modificado</div>
                        </c:if>
                        <c:if test="${respuesta==false}">
                            <div class="alert alert-danger">Empleado NO modificado</div>
                        </c:if>
                    </c:if>
                    ...
                    <form action="servletModificar" method="POST">
                        ...
                        <br>
                        <input type="submit" value="Modificar Empleado" class="btn btn-success">
                        <br>
                    </form>
                </div>
                <div class="col-sm-2">
